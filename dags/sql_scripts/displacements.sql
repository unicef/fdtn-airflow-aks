...
and mmh.date_time >= d.fromdate - INTERVAL '7 day'
...
admin_2_disaster as ( select event_id, gid2 from disasters_hex dh  group by 1,2),

grouped_data as 
(select mapping_meta_final.event_id, date_time , disaster_name, start_adm2, end_adm2, sum(mm.n_difference) as total
...
inner join  admin_2_disaster a2d
on  ( a2d.event_id = mapping_meta_final.event_id and a2d.gid2=mm.start_gid2)


where TRUE 
-- and date_time - start_date <= interval '3 days'
